...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 391.84804199727625; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3056.8334966921793; // x position of the perpendicular encoder (in tick units)
    }
